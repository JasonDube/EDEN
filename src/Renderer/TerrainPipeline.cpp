...
TerrainPipeline::TerrainPipeline(VulkanContext& context, VkRenderPass renderPass, VkExtent2D extent,
...
void TerrainPipeline::createPipelineLayout(VkDescriptorSetLayout textureSetLayout) {
...
void TerrainPipeline::createPipeline(VkRenderPass renderPass, VkExtent2D extent) {
    auto vertShaderCode = m_context.readFile("shaders/terrain.vert.spv");
    auto fragShaderCode = m_context.readFile("shaders/terrain.frag.spv");
    ...
    // Vertex3D binding and attributes
